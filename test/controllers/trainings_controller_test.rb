...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { approaches: @training.approaches, comments: @training.comments, count: @training.count, user_id: @training.user_id } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { approaches: @training.approaches, comments: @training.comments, count: @training.count, user_id: @training.user_id } }
